...
export class ProductDetailEntity extends CommonEntity {
  ...
  @OneToMany(() => ProductColorEntity, (color) => color.productDetails, {
    onDelete: 'CASCADE',
  })
  // @JoinColumn({ referencedColumnName: 'id'})
  colors: ProductColorEntity[];

  @OneToMany(() => ProductImageEntity, (image) => image.productDetails, {
    onDelete: 'CASCADE',
  })
  // @JoinColumn({ referencedColumnName: 'id'})
  images: ProductImageEntity[];

  @OneToMany(() => ProductSizeEntity, (pz) => pz.productDetails, {
    onDelete: 'CASCADE',
  })
